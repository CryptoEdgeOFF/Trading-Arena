...
import type { EventMode, Player, TeamInfo } from '../stores/useGameStore';
...
/**
 * Animation de fin de round (gagnant → podium/roster → stats), partagée entre
 * le dashboard LIVE et les terminaux trader. Aucun son n'est joué ici : les FX
 * audio restent gérés côté dashboard par `ArenaSoundController`.
 */
export default function EventEndOverlay({
  players,
  teams,
  eventMode,
  onClose,
