            ...
            <>
              ...
              <div className="lb-grid">
                ...
                <aside className="lb-side">
                  ...
                  <div className="lb-discord-desktop">
                    <DiscordPanel />
                  </div>
...
const BREAKOUT_DISCORD_URL = 'https://discord.gg/AH8ehHGd29';

function DiscordMark({ size = 26 }: { size?: number }) {
  return (
...
function DiscordPanel() {
  ...
  return (
    <a
      className="lb-discord"
      href={BREAKOUT_DISCORD_URL}
      target="_blank"
      rel="noopener noreferrer"
    >
      <span className="lb-discord__mark"><DiscordMark /></span>
      <span className="lb-discord__copy">
        <small>{t('leaderboard.discordKicker')}</small>
        <strong>{t('leaderboard.discordTitle')}</strong>
        <em>{t('leaderboard.discordCta')}</em>
      </span>
    </a>
  );
}
