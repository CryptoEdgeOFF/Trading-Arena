...
export const en = {
  ...
  livePage: {
    ...
    archived: 'Archived arenas',
    archivedKicker: 'Archive',
  ...
  homeSeason: {
    ...
    bestTitle: 'Who will be the best',
    bestTitleEm: 'of the season?',
    bestLead: 'Season #1 is invited to the Paris Major.',
  ...
  sections: {
    ...
    hintHistory: 'Your past arenas are in the Live tab.',
    historyEyebrow: 'History',
    historyTitle: 'Archived arenas',
    historySub: 'All closed arenas, with their final leaderboard — even the ones you did not join.',
    publicEyebrow: 'Open now',
    seasonEyebrow: 'Current season',
    publicTitle: 'Arenas',
    publicSub: 'Face other traders. Climb the leaderboard. Win rewards.',
  ...
  publicCard: {
    ...
    period: 'Period',
    joined: 'Joined',
    youAreJoined: 'You are registered',
    ...
    leaderboard: 'Leaderboard',
    prizeToWin: 'Prize pool',
    startsIn: 'Starts in',
    endsIn: 'Ends in',
    place: '#{{rank}}',
    paperCompetition: 'Paper Trading competition',
    realCompetition: 'Real-market trading competition',
  ...
  leaderboard: {
    ...
    promoGift: 'Partner gift',
    giftTitle: 'Reserved for Arena Traders for 1 week',
    giftReveal: 'A surprise reserved for arena traders',
    giftDiscover: 'Reveal my gift',
    giftReserved: 'Exclusive BTF Arena bonus',
    giftPrime: 'on your Prime Challenges',
    giftAll: 'on all Challenges',
    copyCode: 'Copy code',
    codeCopied: 'Code copied!',
    giftUseOffer: 'Claim my bonus',
    discordKicker: 'Community',
    discordTitle: 'Breakout',
    discordCta: '+700 Traders',
    ...
    arenaSoon: 'Upcoming arena',
    liveRanking: 'Live ranking',
    performance: 'Performance',
    lastActivity: 'Last activity',
    you: 'You',
    lotsTotal: '{{count}} prize in total',
    lotsTotal_other: '{{count}} prizes in total',
    eventOngoing: 'Ongoing event',
    liveUpdateHint: 'Standings update in real time.',
    lastUpdate: 'Last update',
    raceSubtitle: 'Top 5 progression · real time',
    fightStarts: 'The fight starts in',
    unitDays: 'Days',
    unitHours: 'Hours',
    unitMinutes: 'Minutes',
    unitSeconds: 'Seconds',
    feedTitle: 'Live feed',
    feedOpened: 'just opened a trade on',
    feedClosed: 'just closed a trade on',
    feedEmpty: 'No trade yet.',
  },
  ...
  terminal: {
    ...
    pickArenaLead: 'Select one of your active arenas to open the trading terminal.',
    ...
    arenaEmpty: 'You have no active arenas right now.',
  ...
  rating: {
    ...
    tabHint: 'Season = #1 invited to Paris. BTF Rating = your skill, no qualification.',
    ...
    permanentNotQualifying: 'Measures your skill. Does not qualify for Paris.',
    rulesTitle: 'How to earn points?',
    rulesFirst: '1st',
    rulesSecond: '2nd',
    rulesThird: '3rd',
    rulesTop10: 'Top 10%',
  ...
  arenaChat: {
    ...
    noticeMobile: 'Long-press a message to reply.',
    reply: 'Reply',
  ...
  account: {
    journalHint: 'All your closed trades',
    payoutsHint: 'Prizes and payout requests',
    settingsHint: 'Avatar, name and phone',
    bonusHint: 'Partner offers and promo codes',
