...
export const en = {
  ...
  team: {
    kicker: 'Competition',
    title: 'My team',
    lead: 'Create a team of 4 traders. Everyone trades individually — the ranking adds your PnL together.',
  ...
  joinModal: {
    ...
    teamRequired: 'Create or join a team above before registering.',
