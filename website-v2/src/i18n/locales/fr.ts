...
export const fr: TranslationResources = {
  ...
  share: {
    ...
    publicSpectate: 'Partager le direct',
    publicSpectateText: 'Suis {{title}} en direct sur BTF Arena',
  },
  ...
  seo: {
    ...
    newsDesc: 'Annonces officielles, arènes à venir et infos de la ligue BTF Arena.',
  },
  ...
  globalLeaderboard: {
    ...
    rewardTitle: 'Le n°1 de la saison est invité au Major de Paris',
    rewardDesc: 'Un seul vainqueur par saison : le numéro 1 du classement saisonnier gagne son invitation personnelle pour Paris.',
    qualifies: 'Paris Major',
    prize: {
      eyebrow: '{{season}} · Le grand prix',
      headline: 'Finis n°1 de la saison et trade au Major de Paris',
      subtitle: 'Une arène par semaine pendant toute la {{season}} : le classement additionne ton PnL total. Seul le numéro 1 final décroche sa place pour trader en live à Paris.',
      badgeLabel: 'Badge de Champion',
      badgeHint: 'Voir le badge en grand',
      shirtLabel: 'Maillot officiel du Champion',
      shirtTag: 'Le maillot officiel du champion de saison',
      arenaLabel: 'Accès au Major de Paris',
  ...
  badges: {
    ...
    summerChampionLong: 'Décerné au trader #1 du classement de la Summer Season. En plus du badge, le champion remporte le maillot officiel et son invitation pour trader au Major de Paris.',
    autumnChampion: 'Champion Autumn',
    autumnChampionDesc: '#1 du leaderboard global Autumn Season',
    autumnChampionLong: 'Décerné au trader #1 du classement de l\u2019Autumn Season. Le champion remporte son invitation pour trader au Major de Paris.',
    btf2026: 'BTF 2026',
  ...
  terminal: {
    ...
    pickArenaLead: 'Même compte, mêmes positions que sur mobile. Choisis une arène pour ouvrir le terminal.',
    ...
    arenaEmpty: 'Tu n’as encore rejoint aucune arène.',
  ...
  rating: {
    ...
    permanentNotQualifying: 'Ce classement mesure ton niveau sur le long terme. Il ne donne pas directement accès à Paris : seule ta position dans chaque classement de saison compte.',
