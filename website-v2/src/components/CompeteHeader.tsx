  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto flex max-w-[1440px] items-center justify-between gap-2 px-4 py-2.5 md:px-8">
        <Link to="/" className="group flex shrink-0 items-center gap-2" title="BTF Arena">
          <img
        ...
        <div className="hidden shrink-0 items-center gap-2 lg:flex">
          <Link
            to="/compete/news"
            className={`px-3 py-2 font-['Barlow_Condensed',sans-serif] text-[11px] font-black italic uppercase tracking-[0.14em] transition-colors ${
          ...
          <Link
            to="/"
            className="border border-white/10 bg-white/[0.035] px-3 py-2 font-['Barlow_Condensed',sans-serif] text-[11px] font-black italic uppercase tracking-[0.14em] text-[#b8b8c2] [clip-path:polygon(7px_0,100%_0,100%_calc(100%_-_7px),calc(100%_-_7px)_100%,0_100%,0_7px)] transition-colors hover:border-[#dc2626]/55 hover:text-white"
          >
            Site BTF 2027
          </Link>
          <LanguageSwitcher />
            ...
            <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#08080b] p-2 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.95)]">
              ...
              <nav className="flex flex-col gap-1">
                <Link
                  to="/"
                  onClick={() => setMobileOpen(false)}
                  className="mb-2 flex items-center justify-between border border-[#dc2626]/30 bg-[#dc2626]/10 px-3 py-3 text-xs font-extrabold italic uppercase tracking-[0.12em] text-white"
                >
                  <span>Site événement BTF 2027</span>
