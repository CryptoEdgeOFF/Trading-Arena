      ...
      <main className="relative mx-auto max-w-7xl px-6 pb-24 pt-8 md:px-10">
        ...
        <section id="season" className="mt-10 scroll-mt-24 overflow-hidden rounded-3xl border border-[#f5b300]/35 bg-gradient-to-br from-[#211706] via-[#0d0a07] to-[#09090c] shadow-[0_24px_70px_-45px_rgba(245,179,0,0.55)]">
          ...
          <div className="grid lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,1fr)]">
            <div className="relative aspect-[2/1] overflow-hidden border-b border-[#f5b300]/20 bg-[#120d08] lg:border-b-0 lg:border-r">
              <img
                src={season?.bannerImage || '/assets/Seasons/summer-season-ranking.webp'}
                alt=""
        ...
        <div className="mt-3 overflow-hidden rounded-3xl border border-[#f5b300]/30 bg-gradient-to-br from-[#211706] via-[#0d0a07] to-[#09090c] p-4 sm:p-6">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <article
                key={prize.label}
                className="group relative overflow-hidden rounded-2xl border border-[#f5b300]/15 bg-black/30 px-4 py-5 text-center"
              >
                ...
                <motion.img
                  ...
                  alt=""
                  draggable={false}
                  className="relative z-10 mx-auto h-32 w-auto select-none object-contain sm:h-40"
                ...
                />
                <strong className="relative z-10 mt-3 block text-sm font-black uppercase tracking-[0.08em] text-[#ffe7a3]">
                  {prize.label}
                </strong>
              </article>
            ))}
