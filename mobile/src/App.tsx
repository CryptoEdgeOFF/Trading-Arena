...
function LeaderboardScreen({
  ...
  const prizeTitle = prize
    ? prize.label || (prize.total > 0 ? `${prize.total.toLocaleString(locale)} ${prize.currency || 'USD'}` : t('leaderboard.mainPrize'))
    : ''
      ...
      {error ? (
        ...
        <>
          ...
          <a className="spectate-discord" href="https://discord.gg/AH8ehHGd29" target="_blank" rel="noopener noreferrer">
            <span className="spectate-discord__mark" aria-hidden="true">
