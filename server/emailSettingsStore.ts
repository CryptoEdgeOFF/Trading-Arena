...
export const EMAIL_CATALOG: EmailKindMeta[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'claimText', label: 'Texte — réception', multiline: true, default: "Connecte-toi sur BTF Arena, clique sur ton nom en haut à droite puis « Payout » pour soumettre ton adresse ERC20 et demander le versement de ta récompense." },
      { key: 'buttonLabel', label: 'Texte du bouton', default: 'Demander mon payout ▸' },
  ...
  {
    kind: 'arena_no_trade_reminder',
    label: 'Arène — rappel J+2 sans trade',
    description: "Envoi automatique 2 jours après le départ aux inscrits qui n’ont encore passé aucun trade. Texte dynamique (non éditable).",
    fields: [],
  },
  {
