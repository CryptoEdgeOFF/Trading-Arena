/** Reset du drawdown journalier : 08:00 Europe/Paris (CET/CEST). */
export const DRAWDOWN_TZ = 'Europe/Paris';
export const DRAWDOWN_RESET_HOUR = 8;
...
/** Clé de journée drawdown ('YYYY-MM-DD') : bascule à 08:00 heure de Paris. */
