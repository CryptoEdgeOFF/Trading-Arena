/**
 * Déduit le pays ISO-2 d'un numéro E.164 (déjà normalisé, ex. +33612345678).
 * Correspondance par préfixe le plus long : +1242 → BS, +33 → FR, +1 → US.
 * Le numéro lui-même n'est jamais exposé côté public.
 */

const PREFIXES: Array<[string, string]> = [
  ['+1242', 'BS'], ['+1246', 'BB'], ['+1264', 'AI'], ['+1268', 'AG'],
  ['+1284', 'VG'], ['+1340', 'VI'], ['+1345', 'KY'], ['+1441', 'BM'],
  ['+1473', 'GD'], ['+1649', 'TC'], ['+1664', 'MS'], ['+1671', 'GU'],
...
export function countryFromPhone(phone?: string | null): string | null {
  ...
  if (!value.startsWith('+') || value.length < 8) return null;
  for (const [prefix, iso] of PREFIXES) {
    if (value.startsWith(prefix)) return iso;
  }
  return null;
}
