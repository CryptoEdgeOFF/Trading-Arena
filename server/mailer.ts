...
function renderBreachText(o: BreachEmailOptions): string {
  ...
  const lines = [
    ...
    'Attention : être éliminé te fait perdre des points au classement BTF Rating. Ton total ne descend jamais sous 0.',
  ];
...
function renderBreachHtml(o: BreachEmailOptions): string {
  ...
  const rankLine = o.ratingRank != null
    ? 'Attention : être éliminé te fait perdre des points au classement BTF Rating. Ton total ne descend jamais sous 0. Tu es actuellement'
    : 'Attention : être éliminé te fait perdre des points au classement BTF Rating. Ton total ne descend jamais sous 0.';
