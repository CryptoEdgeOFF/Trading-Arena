...
export const STATIC_MARKET_METADATA: MarketMetadata[] = [
  ...
  { pair: 'SP500/USD', base: 'SP500', quote: 'USD', name: 'S&P 500', coingeckoId: '', imageUrl: null, krakenSymbol: '', category: 'indices', source: 'itick', sourceSymbol: 'SPX500', tradingViewSymbol: 'OANDA:SPX500USD', sortOrder: 120, enabled: true },
  ...
  { pair: 'US30/USD', base: 'US30', quote: 'USD', name: 'Dow Jones 30', coingeckoId: '', imageUrl: null, krakenSymbol: '', category: 'indices', source: 'itick', sourceSymbol: 'US30', tradingViewSymbol: 'OANDA:US30USD', sortOrder: 122, enabled: true },
];
...
export function getMarketMetadataPoolStats(): { max: number | null; total: number; idle: number; waiting: number } | null {
  if (!pool) return null;
